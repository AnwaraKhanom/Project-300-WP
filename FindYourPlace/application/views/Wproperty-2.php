                ...
                <div class="clearfix padding-top-40" >
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                            ...
                                            <li data-thumb="<?=base_url()?>image/Property/<?=$proper[0]['p_photo']?>"> 
                                                ...
                                                <img src="<?=base_url()?>image/Property/<?=$proper[0]['p_photo']?>">
                                            </li>
                    ...
                    <div class="col-md-4 p0">
                        <aside class="sidebar sidebar-property blog-asside-right property-style2">
                                        ...
                                        <div class="property-meta entry-meta clearfix ">   
                                            ...
                                            <div class="col-xs-4 col-sm-4 col-md-4 p-b-15">
                                                ...
                                                <span class="property-info-entry">
                                                    ...
                                                    <span class="property-info-value"><?php if($proper[0]['status']==1){ echo 'Available'; }else{ echo 'Not Available'; } ?></span>
                                                </span>
                                            </div>
                                        ...
                                        <div class="clear">
                                            <div class="col-xs-4 col-sm-4 dealer-face">
                                                <a href="">
                                                   ...
                                                   <!-- <img src="<?=base_url()?>asset/assets/img/client-face1.png" class="img-circle">-->
                                                </a>
                                            </div>
                            ...
                            <?php if($proper[0]['status']==1){ echo '<div class="panel panel-default sidebar-menu wow fadeInRight animated" >
                                <div class="panel-body search-widget">
                                    <fieldset >
                                            
                                                <div class="col-xs-12"> 

                                                   <a href="'.base_url().'login"><button class="button btn largesearch-btn" type="submit">Book</button></a> 
