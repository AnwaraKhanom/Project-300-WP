            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
                    <div class="button navbar-right">
                        <button class="navbar-btn nav-button wow bounceInRight login" onclick=" window.open('<?=base_url()?>login')" data-wow-delay="0.4s">Login</button>
                        <button class="navbar-btn nav-button wow fadeInRight" onclick=" window.open('<?=base_url()?>register')" data-wow-delay="0.5s">Register</button>
                    </div>
                    <ul class="main-nav nav navbar-nav navbar-right">
                        ...
                        <li class="wow fadeInDown" data-wow-delay="0.1s"><a class="" href="<?=base_url()?>Wproperties">Properties</a></li>
                        
                        

                        <li class="wow fadeInDown" data-wow-delay="0.4s"><a href="<?=base_url()?>Wcontact">Contact</a></li>
                    </ul>
                </div>
        </nav>