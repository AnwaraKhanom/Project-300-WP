                            ...
                            <div class="col-sm-6 col-md-3 p0">
                                <div class="box-two proerty-item">
                                    <div class="item-thumb">
                                        <a href="<?=base_url()?>wproperty/<?=$property['id']?>" ><img src="<?=base_url()?>image/Property/<?=$property['photo']?>"></a>
                                    </div>

                                    <div class="item-entry overflow">
                                        <h5><a href="<?=base_url()?>wproperty/<?=$property['id']?>"> <?=$property['name']?> </a></h5>
                        ...
                        <div class="col-sm-6 col-md-3 p0">
                            <div class="box-tree more-proerty text-center">
                                ...
                                <div class="more-entry overflow">
                                    <h5><a href="<?=base_url()?>Wproperties" >CAN'T DECIDE ? </a></h5>
                                    
                                    <a href="<?=base_url()?>Wproperties" ><button class="btn border-btn more-black" value="All properties " >All properties</button></a>
                                </div>
                            </div>
                        </div>
