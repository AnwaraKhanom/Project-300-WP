                                    ...
                                    <div class="card-body">
                                        ...
                                        <table  class="table table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?=base_url()?>image/Property/<?=$pro['p_photo']?>"><?=$pro['p_photo']?></a></td>
                                                
                                                
                                                <td><a href="<?=base_url()?>Dashboard/delete-property/<?=$pro['p_id']?>"><button class="btn btn-danger">Delete</button></a></td>
                                            </tr>
