                                        ...
                                        <?=$this->session->flashdata('success')?>
                                                <form action="" method="post">
                                                    ...
                                                    <div class="form-group"> 
                                                        ...
                                                        <input type="text" class="form-control py-4" placeholder="Enter Division" value="<?php if(set_value('division')){ echo set_value('division'); }else{ echo $user[0]['division']; } ?>" name="division">
