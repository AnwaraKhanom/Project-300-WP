                                        ...
                                        <div class="property-meta entry-meta clearfix ">   
                                            ...
                                            <div class="col-xs-4 col-sm-4 col-md-4 p-b-15">
                                                ...
                                                <span class="property-info-entry">
                                                    ...
                                                    <span class="property-info-value"><?php if($proper[0]['status']==1){ echo 'For Available'; }else{ echo 'Not Available'; } ?></span>
                                                </span>
                                            </div>
                                ...
                                <div class="panel-body search-widget">
                                    <fieldset >
                                                ...
                                                <div class="col-xs-12"> 
                                                   ...
                                                   <a href="'.base_url().'Findplace/request/'.$proper[0]['p_id'].'"><button class="button btn largesearch-btn" type="submit">Book</button></a> 
