                ...
                <div class="col-md-3 p0 padding-top-40">
                    <div class="blog-asside-right pr0">
                        <div class="panel panel-default sidebar-menu wow fadeInRight animated" >
                            ...
                            <form action="<?=base_url()?>Welcome/Wproperties" method="post" >
                                ...
                                <div class="col-sm-6 col-md-4 p0">
                                        <div class="box-two proerty-item">
                                            <div class="item-thumb">
                                                <a href="<?=base_url()?>wproperty/<?=$property['p_id']?>" ><img src="<?=base_url()?>image/Property/<?=$property['photo']?>"></a>
                                            </div>

                                            <div class="item-entry overflow">
                                                <h5><a href="<?=base_url()?>wproperty/<?=$property['p_id']?>"> <?=$property['name']?> </a></h5>
